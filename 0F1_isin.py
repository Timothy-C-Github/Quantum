# -*- coding: utf-8 -*-
"""
Created on Fri Jan 17 21:51:54 2025
...
y_true = []
for i in x_values:
    y_true.append(1j * cmath.sin(i))  # Target: sine of x
...
def optimize_z_for_b(b, x_values, y_true):
    ...
    initial_z = np.random.uniform(-25.0, 25.0, len(x_values))  # Random initial guesses for z
...
b_values = np.linspace(-50.0, 50.0, 1001)  # Test different b values from 0.1 to 2.0
